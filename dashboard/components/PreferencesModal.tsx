  ...
  return (
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-center z-50 p-4 pointer-events-none">
        <div
          className="bg-white rounded-3xl shadow-2xl max-w-3xl w-full max-h-[90vh] overflow-y-auto pointer-events-auto"
        ...
        >
          ...
          <div className="sticky top-0 bg-white border-b border-gray-200 px-8 py-6 flex items-center justify-between rounded-t-3xl">
            <h2 className="text-3xl font-semibold">Preferences</h2>
            <button
              onClick={onClose}
          ...
          <div className="px-8 py-6 space-y-8">
            {Object.entries(PREFERENCE_CATEGORIES).map(([category, options]) => (
              <div key={category}>
                <h3 className="text-lg text-amber-800 mb-4">{category}</h3>
          ...
          {/* Footer */}
          <div className="sticky bottom-0 bg-white border-t border-gray-200 px-8 py-6 flex items-center justify-between rounded-b-3xl">
            <button
            ...
            <div className="flex gap-4">
              ...
              <button
                onClick={handleSave}
                className="px-8 py-3 bg-gray-900 text-white rounded-full hover:bg-black transition-colors font-medium"
              >
                Save
              </button>
            </div>
